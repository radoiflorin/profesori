@extends('layouts.app')
@section('title', 'Adauga Ora - Admin Scoala')
@section('page-name', 'timetable-add')
@section('topbar-title', 'Adauga Ora')
            ...
            <form method="POST" action="{{ route('timetables.store') }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" name="class" placeholder="10A, 11B..." value="{{ old('class') }}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Sala</label>
                        <input type="text" class="form-control" name="room" placeholder="Sala 1, Lab 5..." value="{{ old('room') }}">
                    </div>
                </div>
